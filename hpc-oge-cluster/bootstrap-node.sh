...
yum -y install openssl libxml2 tcsh
...
echo "its-genomics-hn:/opt/gridengine /opt/gridengine nfs defaults,nfsvers=3,tcp,retry=30,rsize=8192,wsize=8192 0 0" >> /etc/fstab
mount /opt/gridengine
echo "its-genomics-hn:/home /home nfs defaults,async,nfsvers=3,tcp,retry=30,rsize=8192,wsize=8192 0 0" >> /etc/fstab
mount /home
